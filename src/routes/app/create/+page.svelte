<script lang="ts">
	...
	let imagePreview = $state(form?.values?.image_src ?? '');
...
<div class="page">
	<div class="card">
		...
		<form method="POST" class="activity-form">
				...
				<div class="field">
					...
					<select id="category_id" name="category_id">
						...
						{#each categoryOptions as option}
							<option value={option.value} selected={(form?.values?.category_id ?? '') === option.value}>
								{option.label}
							</option>
						{/each}
					</select>
				...
				<div class="field">
					...
					<select id="gender_id" name="gender_id">
						{#each genderOptions as option}
							<option value={option.value} selected={(form?.values?.gender_id ?? '') === option.value}>
								{option.label}
							</option>
						{/each}
					</select>
			...
			<div class="field">
				<label for="image_upload">Įkelti nuotrauką iš kompiuterio</label>
			...
			<div class="field">
				...
				<input
					...
					type="text"
					placeholder="https://..."
					value={form?.values?.image_src && !form.values.image_src.startsWith('data:image/') ? form.values.image_src : ''}
					oninput={(e) => {
			...
			<input id="image_src" name="image_src" type="hidden" value={form?.values?.image_src ?? ''} />
