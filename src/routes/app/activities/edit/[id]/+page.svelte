	...
	<div class="card">
		...
		<form method="POST" class="activity-form">
			<div class="field">
				...
				<input id="name" name="name" type="text" maxlength="30" value={form?.values?.name ?? activity.name} />
				{#if form?.errors?.name}
			...
			<div class="field">
				...
				<input id="location" name="location" type="text" value={form?.values?.location ?? activity.location ?? ''} />
			</div>

			<div class="field">
				<label for="starts_at">Data ir laikas</label>
				<input id="starts_at" name="starts_at" type="datetime-local" value={form?.values?.starts_at ?? toDateTimeLocal(activity.starts_at)} />
			...
			<div class="grid-two">
				<div class="field">
					...
					<input id="category_id" name="category_id" type="number" min="1" value={form?.values?.category_id ?? activity.category_id} />
				...
				<div class="field">
					...
					<input id="gender_id" name="gender_id" type="number" min="1" value={form?.values?.gender_id ?? activity.gender_id ?? ''} />
			...
			<div class="field">
				...
				<input id="image_src" name="image_src" type="text" value={form?.values?.image_src ?? activity.image_src ?? ''} />
			</div>
